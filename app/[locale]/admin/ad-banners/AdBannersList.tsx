...
export default function AdBannersList({
  ...
  const t = useTranslations("admin.adBanners");
  ...
  const handleDelete = async (id: number) => {
    const isConfirmed = confirm(t("deleteConfirmation"));
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-col md:flex-row space-y-1 ">
        ...
        >
          <Plus className="ml-2" size={20} /> {t("addNew")}
        </Button>
      </div>
          ...
          <div className="flex-1 overflow-y-auto px-8 pb-8 space-y-6 custom-scrollbar">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="font-bold mr-1">{t("targetLink")}</Label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="font-bold mr-1">{t("activtionDate")}</Label>
                ...
                <div className="space-y-2">
                  <Label className="font-bold mr-1">{t("duration")}</Label>
                  <div className="relative">
                    <Input
                      type="number"
                      min="1"
