        ...
        <div className="grid grid-cols-2 gap-y-6">
          {category === "passenger" && (
            <>
              <SpecItem
                label="الناقل"
                value={ArabicLabels.Transmission[specs.transmission]}
              />
              <SpecItem
                label="التسجيل"
                value={ArabicLabels.RegistrationType[specs.registrationType]}
              />
              <SpecItem
                label="الهيكل"
                value={ArabicLabels.CarBodyType[specs.carBodyType]}
              />
              <SpecItem
                label="الدفع"
                value={ArabicLabels.DriveSystem[specs.driveSystem]}
              />
              <SpecItem
                label="معدل"
                value={specs.isModified ? "معدل" : "غير معدل"}
              />
          ...
          {category === "truck" && (
            <>
              ...
              <SpecItem
                label="طول الصندوق"
                value={`${specs.backstorageLenght} م`}
              />
          ...
          {category === "motor" && (
            <>
              ...
              <SpecItem
                label="مسجل"
                value={specs.isRegistered ? "نعم" : "لا"}
              />
