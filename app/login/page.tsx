...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 font-sans" dir="rtl">
        ...
        <CardContent className="pb-10 space-y-6">
          ...
          {step === 1 ? (
            <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
              ...
              >
                {isPending ? <Loader2 className="animate-spin" /> : "إرسال الكود"}
              </Button>
            </div>
          ) : (
            <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
              ...
              <div className="space-y-3">
                ...
                >
                  {isPending ? <Loader2 className="animate-spin" /> : "تحقق الآن"}
                </Button>
